...
Offer **multi-context**: a root `CONTEXT-MAP.md` pointing to per-context `CONTEXT.md` files. Offer it only when exploration found monorepo signals. Then confirm which layout they want.
